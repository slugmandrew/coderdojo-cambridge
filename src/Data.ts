...
const getProjects: () => Project[] = () => {
  const projects: Project[] = [
    ...
    { language: "Scratch", level: "Beginner", title: "", url: "" },
    { language: "Java", level: "Beginner", title: "", url: "" },
    { language: "Unity", level: "Beginner", title: "", url: "" },
    { language: "HTML", level: "Beginner", title: "", url: "" },
  ]
