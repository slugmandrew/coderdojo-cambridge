...
import { Container, Flex, Heading, VStack, Text, Link, Box, Image } from "@chakra-ui/react";
      ...
      <Flex w={"full"} h={"full"} padding={10}>
        <VStack spacing={10} ali w={"full"} h={"full"}>
          ...
          <Heading size={"lg"} paddingY={3}>
            <Link href={"https://coderdojo-cambridge.herokuapp.com/"}
                  target={"_blank"}>coderdojo-cambridge.herokuapp.com</Link>
          </Heading>
