  ...
  <TopicLayout
    ...
    body={
      <>
        ...
        <List spacing='xs'>
          <List.Item>
            <strong>Level 1</strong> - Focus on learning the basic syntax and user input, plus some randomness and simple maths.
          </List.Item>
          <List.Item>
            <strong>Level 2</strong> - Progress to variables and control structures like <code>if-else</code>, <code>while</code> loops, <code>for</code> loops
            and useful functions like <code>str()</code> and <code>int()</code>.
          </List.Item>
          <List.Item>
            <strong>Level 3</strong> - Introduce more complex concepts such as <code>lists</code>, <code>arrays</code> and <code>hashmaps</code>, with room to
