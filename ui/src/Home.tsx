...
export const Home = () => (
  <>
    ...
    <ContentCard>
      <Box>
        <SimpleGrid columns={[null, 1, 2, 3]} spacing={10} px={5} py={5}>
          <Box>
          ...
          <Box>
            ...
            <Text>
              We are always looking for new mentors. If you are interested in helping out at one of our sessions, or just giving it a try, please get in touch.
